...
class ImageGenerator:
    ...
    def cal_Wass_with_T(self, batch_idx, batch=None, pbar=None, result_path=None):
        ...
        if self.wass_model is not None:
            ...
            # results['distances_sinkhorn_w2_image'] = distances_sinkhorn_w2_image
            # results['Neighbor_distances_sinkhorn_w2_image'] = np.array(Neighbor_distances_sinkhorn_w2_image).mean()
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        ...
                        default = '/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data_tsy/kvasir_doctor/matched_result_flat.json',
                        help='数据路径') 
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/result_tsy/kvasir_doctor/image_hint_oldattn_Disease_new_extra_50000_tsy_final_img5',
    ...
    parser.add_argument('--bias', type=bool, default=False,
                        help='')  
    parser.add_argument('--temp', type=str, default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/temp/temp1',
                        help='')
