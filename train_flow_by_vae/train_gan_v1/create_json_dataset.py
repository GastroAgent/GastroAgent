...
image_root = '/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/step_score_generated/similarity_images_draw' # GME
...
for label in labels:
    ...
    for image_dir_path in image_dir_paths:
        ...
        if '#to#' in image_dir_path.split('/')[-1]:
...
eval_size = min([int(len(dataset) * 0.1), 10000])
train_dataset = dataset[:-eval_size]
eval_dataset = dataset[-eval_size:]
print(f'Dataset Size: {len(dataset)}')
print(f'Train Dataset Size: {len(train_dataset)}')
print(f'Eval Dataset Size: {len(eval_dataset)}')
with open('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/step_score_generated/eval_triplet_all_dataset.json', 'w') as f:
    json.dump(eval_dataset, f, indent=4, ensure_ascii=False)
with open('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/step_score_generated/train_triplet_all_dataset.json', 'w') as f:
    json.dump(train_dataset, f, indent=4, ensure_ascii=False)
with open('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/step_score_generated/triplet_all_dataset.json', 'w') as f:
