...
# images = glob('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/new_cropped-2004-2010/*.jpg') + glob('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/new_cropped-2004-2010/*.png')
images = glob("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/images_dia/*/*.jpg") + glob("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/train/train_gan_v2/images_dia/*/*.png")
num_failed = 0
num_total = 0
file_idx = 1
for image in tqdm(images):
    ...
    failed = crop_save(image,
                       save_path=image, # new_path: 新存放路径。image: 旧的路径。
