...
if __name__ == '__main__':
    ...
    json_paths = glob.glob(
        "/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/data_pairs_tiny/*.json")
    ...
    test_json = [
        "/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/十二指肠/eval_all.json",
    ]
        ...
        for step in tqdm(range(total_step)):
            ...
            if (step + 1) % save_step == 0:
                ...
                if best_acc < accuracy:
                    torch.save(model.state_dict(), f"/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_十二指肠.pt")
                    torch.save(classifer.state_dict(), f"/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_十二指肠_classifer.pt")
                    best_acc = accuracy
                else:
                    pass
    ...
    ### 加载 checkpoints
    try:
        state_dict = torch.load("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_十二指肠.pt", weights_only=True)
        model.load_state_dict(state_dict, strict=True)
        state_dict = torch.load("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_十二指肠_classifer.pt", weights_only=True)
