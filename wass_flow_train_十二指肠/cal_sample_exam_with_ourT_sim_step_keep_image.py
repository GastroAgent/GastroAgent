...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/十二指肠/eval_all_flatten.json',
                        help='数据路径') 
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/outputs/image_hint_十二指肠/otcfm/otcfm_weights_step_75000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/image_hint_十二指肠_75000_3',
    ...
    parser.add_argument('--wass_model_path', type=str, 
                        default="/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_十二指肠.pt",
                        help='优先级 高于 权重')
