    ...
    def generate(self, batch=None, test=False, sample_step=-1, return_all_steps=False, mode='default'):
        ...
        if mode == 'sim_stop':
            if return_all_steps:
                ...
                result['stop_step_sim'] = stop_step_sim
...
def generate_parse_args():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/outputs/image_hint_十二指肠/otcfm/otcfm_weights_step_50000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/image_hint_十二指肠',
