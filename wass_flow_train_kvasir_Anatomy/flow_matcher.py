    ...
    def _load_model(self, checkpoint: str, use_ema=False):
        ...
        if not self.only_vae:
            config = json.load(open(
                '/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/unet_flow/config.json',
                'r'))
            print("time_embedding_type: ", config['time_embedding_type'])
            ...
            if self.args.use_controlnet:
                try:
                    controlnet_config = json.load(
                        open("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/unet_flow/controlnet_config.json",
                            'r'))
...
def generate_parse_args():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/outputs_fourier/image_hint/otcfm/otcfm_weights_step_100000.pt',
