...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/Antomy/exam_wass_dataset_test_k5_all_crop.json',
                        help='数据路径') 
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/outputs/image_hint_Anatomy/otcfm/otcfm_weights_step_75000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/image_hint_Anatomy_75000_s3_crop',
    ...
    parser.add_argument('--wass_model_path', type=str, 
                        default="/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_anatomy.pt",
                        help='优先级 高于 权重')
