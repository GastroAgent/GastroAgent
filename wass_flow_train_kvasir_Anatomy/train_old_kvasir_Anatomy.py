...
if __name__ == '__main__':
    ...
    json_paths = glob.glob( # 需要是 同类的数据。
        "/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/Antomy/data_pairs/*.json")
    ...
    test_json = "/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/Antomy/exam_dataset_all.json"
        ...
        for step in tqdm(range(total_step)):
            ...
            if (step + 1) % save_step == 0:
                ...
                if best_acc < accuracy:
                    torch.save(model.state_dict(), f"/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/old_attention_Anatomy.pt")
                    best_acc = accuracy
                else:
                    pass
        if best_acc < accuracy:
    ...
    def evaluate_triplet_new(model, dataset, device, generator, step=0, k=1):
        ...
        print(f"Evaluation Accuracy: {accuracy:.4f}")
        return accuracy
    evaluate_triplet_new(model, dataset, device, generator, 0, 5)
    print("OLd")