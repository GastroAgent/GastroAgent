...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        # default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/data_tsy1/食管_doctor/final_doctor_exam_flat.json',
                        default = "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/data_tsy1/final_eval_json/new_eval_tsy_flatten.json",
                        help='数据路径') 
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/outputs/flow-match_vae/otcfm/otcfm_weights_step_100000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/result/attention_dy_tsy_new_100000_sim3_91',
    ...
    parser.add_argument('--sim_model_path', type=str, 
                        default = "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/discriminator/latent_model_weight/convnext3.pt",
