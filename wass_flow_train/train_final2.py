        ...
        for step in tqdm(range(total_step)):
            ...
            for bx, (pos_trajectorys, neg_trajectorys) in enumerate(zip(batchs_pos_trajectorys, batchs_neg_trajectorys)):
                ...
                for i in range(len(pos_trajectorys)-1):
                    ...
                    cur_embeding = pos_trajectorys_emb[i+1:i+2]
                ...
                for i in range(len(neg_trajectorys)-1):
                    ...
                    cur_embeding = neg_trajectorys_emb[i+1:i+2]
            ...
            if (step + 1) % save_step == 0:
                ...
                if best_acc < accuracy:
                    torch.save(model.state_dict(), f"/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights/sum2_attention_dy_tsy.pt")
                    torch.save(classifer.state_dict(), f"/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights/sum2_attention_dy_tsy_classifer.pt")
                    best_acc = accuracy
                else:
                    pass
        if best_acc < accuracy:
