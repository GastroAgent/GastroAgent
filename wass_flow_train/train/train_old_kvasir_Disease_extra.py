...
if __name__ == '__main__':
        ...
        for step in tqdm(range(total_step)):
            ...
            if (step + 1) % save_step == 0:
                ...
                if best_acc < accuracy:
                    torch.save(model.state_dict(), f"/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/old_model_Disease_Extra.pt")
                    best_acc = accuracy
                else:
                    pass
    ...
    ### 加载 checkpoints
    try:
        state_dict = torch.load("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/old_attention_Disease_Extra.pt", weights_only=True)
        ...
        with torch.no_grad():
            for data in tqdm(dataset):
                ...
                with torch.no_grad():
                    ...
                    trajectorys_emb = model.encode(trajectorys, False)
