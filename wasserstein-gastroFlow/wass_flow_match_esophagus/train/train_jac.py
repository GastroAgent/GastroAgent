        ...
        for step in tqdm(range(total_step)):
            ...
            if (step + 1) % save_step == 0:
                ...
                if best_acc < accuracy:
                    torch.save(model.state_dict(), f"./best_flow_weights/attention_norm_jac_tsy.pt")
                    torch.save(classifer.state_dict(), f"./best_flow_weights/attention_norm_jac_tsy_classifer.pt")
                    best_acc = accuracy
                else:
                    pass
