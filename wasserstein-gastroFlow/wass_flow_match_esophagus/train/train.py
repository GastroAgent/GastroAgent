    ...
    def train_triplet(epochs=20, dataloaders=None):
        ...
        for step in tqdm(range(total_step)):
            ...
            if generator is not None and use_generate:
                ...
                generator.num_steps = random.choice([6, 8, 10, 12, 14, 16, 18, 6])
            ...
            # loss = loss + 0.001 * clip_loss(anchor_emb, anchor_emb)
            # loss = loss + 0.001 * clip_loss(positive_emb, positive_emb)
            # loss = loss + 0.001 * clip_loss(negative_emb, negative_emb)
