    ...
    def _load_model(self, checkpoint: str, use_ema=False):
        ...
        if not self.use_gt_vt:
            ...
            if self.args.wass_model_path:
                ...
                from model_utils.model import TripletNetworkssss
            ...
            if self.args.sim_model_type == 'dinov3':
    ...
    def cal_Wass_with_discriminator(self, batch_idx, batch=None, pbar=None, result_path=None, keep_last_generated=True):
        ...
        for step in range(1, len(trajectory[:-1])):
            ...
            if binary_pred:
                ...
                if label_A == label_B:
                    fake_path = f"./train/train_gan_v1/hard_fake/cal_wass_dis/{label_A}#to#{label_B}"
                else:
                    fake_path = f"./train/train_gan_v1/fake/cal_wass_dis/{label_A}#to#{label_B}"
