...
class ImageGenerator:
    ...
    def _load_model(self, checkpoint: str, use_ema=False):
        ...
        if not self.use_gt_vt:
            ...
            try:
                state_dict = load_file("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/text_encoder/model.safetensors")
            ...
            vision_model.load_state_dict(torch.load("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/EndoViT/pytorch_model.bin", weights_only=False), strict=False)
            ...
            if self.args.sim_model_type == 'gme':
                from model_utils.gme_inference import GmeQwen2VL
...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/test/model_Disease_extra_image_hint_Disease',
