...
if __name__ == '__main__':
    ...
    test_json = "/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/食管/eval_all.json"
        ...
        for step in tqdm(range(total_step)):
            ...
            if (step + 1) % save_step == 0:
                ...
                if best_acc < accuracy:
                    torch.save(model.state_dict(), f"/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_食管.pt")
                    best_acc = accuracy
                else:
                    pass
    ...
    ### 加载 checkpoints
    try:
        state_dict = torch.load("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_食管.pt", weights_only=True) # 0.
