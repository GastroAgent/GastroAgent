    ...
    def _load_model(self, checkpoint: str, use_ema=False):
        ...
        if not self.use_gt_vt:
            ...
            if self.args.wass_model_path:
                from old_model import TripletNetwork
                if 'attention' == self.args.wass_model_type:
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/食管/eval_all_flatten.json',
                        help='数据路径') 
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/outputs/image_hint_食管/otcfm/otcfm_weights_step_30000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/image_hint_oldattn_食管_30000',
    ...
    parser.add_argument('--bias', type=bool, default=True,
                        help='')  
    parser.add_argument('--temp', type=str, default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/temp/temp2',
                        help='')
    ...
    parser.add_argument('--wass_model_path', type=str, 
                        default="/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/best_flow_weights/attention_食管.pt",
                        help='优先级 高于 权重')
