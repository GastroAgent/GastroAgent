...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/Disease_Extra/tsy/exam_wass_dataset_test_extra.json',
                        help='数据路径') 
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/tsy/image_hint_resnet_Disease_extra_50000',
