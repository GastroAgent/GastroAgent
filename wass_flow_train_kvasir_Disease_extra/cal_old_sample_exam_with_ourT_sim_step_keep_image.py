...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        ...
                        default = '/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/exam_dataset_extra_test_k5_all.json',
                        help='数据路径') 
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/outputs/image_hint_Disease_extra/otcfm/otcfm_weights_step_75000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/image_hint_oldattn_Disease_new_extra_75000_s2_k5',
