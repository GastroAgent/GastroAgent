...
def generate_parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/data/new_eval_all_flatten.json',
                        help='数据路径') 
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/result/image_hint_new_eval_all_attnbest_ours_sim_50000',
