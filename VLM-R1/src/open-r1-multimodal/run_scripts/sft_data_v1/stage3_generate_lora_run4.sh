...
RUN_NAME="Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-all-RL-2500-option1-add-cot-sft"
...
torchrun \
    ...
    --version qwen2_vl \
    --data_path /mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data_tsy/mllm/all_disease_vqa/option_add1/all_cot_think_samples.json \
