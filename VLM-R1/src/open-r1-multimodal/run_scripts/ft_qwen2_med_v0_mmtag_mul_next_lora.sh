...
RUN_NAME="ft_qwen2_med_v0_mmtag_mul_next-Stage2-3"
...
# sbatch -p vip_gpu_01 --gpus=4  /home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/run_scripts/ft_qwen2_med_v0_mmtag_mul_next_lora.sh
# sbatch -p vip_gpu_01 --gpus=2  /home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/run_scripts/ft_qwen2_med_v0_mmtag_mul_next_lora.sh
...
torchrun --nnodes=1 --nproc_per_node=2 --master_port=25001 \
    ...
    --model_name_or_path /home/dalhxwlyjsuo/criait_tansy/weight/Llava-Qwen2-7B-knowtune-med-v0-mmtag-mul-next-stage2-3 \
    --version v0_mmtag \
    ...
    --bf16 True \
    --output_dir /home/dalhxwlyjsuo/criait_tansy/checkpoints/Llava-Qwen2-7B-knowtune-med-v0-mmtag-mul-next-stage2-4 \
    --num_train_epochs 1 \
