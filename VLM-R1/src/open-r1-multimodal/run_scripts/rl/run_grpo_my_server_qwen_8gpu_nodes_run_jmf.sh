...
RUN_NAME="Llava-Qwen2-7B-tune-med-sft-jmf-tsy-rl-cota-jmf"
...
# nvidia-smi -l 2 > /mnt/inaisfs/data/home/tansy_criait/VLM-R1/src/open-r1-multimodal/run_scripts/tsy/gpu_monitor.log &
...
torchrun \
    ...
    /mnt/inaisfs/data/home/tansy_criait/VLM-R1/src/open-r1-multimodal/run_scripts/tsy/rl/grpo_jsonl.py \
    --output_dir $OUTPUT_DIR/$RUN_NAME \
    --model_name_or_path /mnt/inaisfs/data/home/tansy_criait/weights/Llava-Qwen2-7B-tune-med-SFT \
    --use_peft true \
    --reward_funcs acc_nobox_nooption new_format \
    --use_rslora true \
    --use_vllm false \
    --vllm_gpu_memory_utilization 0.3 \
    --dataset_name none \
    --image_folders /home/lab/data/OmniMedVQA/Images \
    --data_file_paths /mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data_tsy/mllm/all_disease/cot_think_samples_a.json \
