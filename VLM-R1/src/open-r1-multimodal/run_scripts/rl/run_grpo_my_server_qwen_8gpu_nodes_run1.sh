...
RUN_NAME="Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-all-RL-2500-option-add-cot-sft-rl"
...
torchrun \
    ...
    --model_name_or_path /mnt/inaisfs/data/home/tansy_criait/weights/tsy/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-all-RL-2500-option-add-cot-sft \
    --use_peft true \
    ...
    --data_file_paths /mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data_tsy/mllm/all_disease_vqa/option_add/all_cot_think_samples.json \
