...
RUN_NAME="Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-all-option-add-cot-sft-rl"
...
torchrun \
    ...
    --model_name_or_path /mnt/inaisfs/data/home/tansy_criait/weights/tsy/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-all-option-add-cot-sft \
    --use_peft true \
