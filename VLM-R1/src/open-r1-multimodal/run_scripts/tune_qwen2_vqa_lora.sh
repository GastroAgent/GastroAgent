...
RUN_NAME="tune_qwen2_med_v0_mmtag_mul_next-VQA"
...
# sbatch -p vip_gpu_01 --gpus=2 /home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/run_scripts/tune_qwen2_vqa_lora.sh
...
torchrun --nnodes=1 --nproc_per_node=2 --master_port=25001 \
    ...
    --model_name_or_path /home/dalhxwlyjsuo/criait_tansy/weight/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-next-Stage3_epoch3 \
    --version direct \
    --data_path /home/dalhxwlyjsuo/criait_tansy/jmf/vqa_train.jsonl \
    ...
    --bf16 True \
    --output_dir /home/dalhxwlyjsuo/criait_tansy/checkpoints/Llava-Qwen2-7B-tune-med-VQA \
    --num_train_epochs 1 \
