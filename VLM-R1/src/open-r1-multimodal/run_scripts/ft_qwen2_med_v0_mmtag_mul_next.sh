...
# sbatch -p vip_gpu_01 --gpus=8  /home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/run_scripts/ft_qwen2_med_v0_mmtag_mul_next.sh
# sbatch -p vip_gpu_01 --gpus=1  /home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/run_scripts/ft_qwen2_med_v0_mmtag_mul_next.sh
...
torchrun --nnodes=1 --nproc_per_node=8 --master_port=25001 \
    ...
    --version v0_mmtag \
    --data_path  /home/dalhxwlyjsuo/criait_tansy/jmf/data/stage2_3.json \
    ...
    --bf16 True \
    --output_dir /home/dalhxwlyjsuo/criait_tansy/weight/Llava-Qwen2-7B-knowtune-med-v0-mmtag-mul-next-stage2-1 \
    --num_train_epochs 1 \
