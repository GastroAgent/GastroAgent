...
RUN_NAME="Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-option1-add-sft"
...
torchrun \
    ...
    --model_name_or_path /mnt/inaisfs/data/home/tansy_criait/weights/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest \
    --version qwen2_vl \
    --data_path /mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data_tsy/mllm/all_disease_vqa/option_add1/all_merged_disease_vqa_option_format.json \
