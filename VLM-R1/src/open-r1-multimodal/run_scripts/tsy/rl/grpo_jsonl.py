...
openai_api_key = 'xxxx'
openai_api_base = "http://gpu35:8000/v1"
...
def medical_diagnosis_score_generate_multimodal(
    ...
    model_name: str = "tsy-medical-validator",  # or your served Qwen-VL model name
    max_tokens: int = 512,
...
def medical_diagnosis_score_generate(
    ...
    model_name: str = "tsy-medical-validator",  # 建议使用医学微调模型，如 "meditron-7b" 或 "clinical-camel"
    max_tokens: int = 64,
