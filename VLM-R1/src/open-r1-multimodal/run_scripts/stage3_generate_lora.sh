...
RUN_NAME="Med-Qwen2.5-VL-7B"

export WANDB_API_KEY="046193756f0009d71636370009dbcee76f3bd3ac"
export WANDB_MODE="offline"
#export CUDA_VISIBLE_DEVICES=3,4,6,7

# sbatch -p vip_gpu_01 --gpus=4 /home/dalhxwlyjsuo/criait_tansy/Node_Code/126/work/VLM-R1/src/open-r1-multimodal/run_scripts/stage3_generate_lora.sh
...
torchrun --nproc_per_node="4" \
    ...
    --model_name_or_path /home/dalhxwlyjsuo/criait_tansy/weight/Qwen2.5-VL-7B-Instruct \
    --version qwen2_vl \
    --data_path /home/dalhxwlyjsuo/criait_tansy/vqadataset/train_VQA_SFT.json \
    ...
    --bf16 True \
    --output_dir /home/dalhxwlyjsuo/criait_tansy/checkpoints/Med-Qwen2.5-VL-7B \
    --num_train_epochs 1 \
