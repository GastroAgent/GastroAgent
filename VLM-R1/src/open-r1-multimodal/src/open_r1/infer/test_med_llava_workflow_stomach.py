...
# ===== 配置参数 =====
model_id = '/mnt/inaisfs/data/home/tansy_criait/weights/tsy/Stomach-Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest'
data_name = '胃'
batch_size = 1
model_name = 'Stomach-Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest'

data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/doctor_胃/new_eval_tsy_llm.json'
lora_model_path = None
model_save_path = None

data_save_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/results/doctor_胃_workflow_gemini/sft/{model_name}/{data_name}.json'
os.makedirs(f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/results/doctor_胃_workflow_gemini/sft/{model_name}', exist_ok=True)
