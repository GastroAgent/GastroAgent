...
model_id = '/mnt/inaisfs/data/home/tansy_criait/weights/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest'

data_name = 'kvasir'
batch_size = 1 
model_name = 'Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest' # 2: is_message=True

#data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/Kvasir/Kvasir-en-workflow.json'
...
data_save_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/results/kvasir_workflow1/{model_name}/{data_name}.json'
os.makedirs(f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/results/kvasir_workflow1/{model_name}', exist_ok=True)
