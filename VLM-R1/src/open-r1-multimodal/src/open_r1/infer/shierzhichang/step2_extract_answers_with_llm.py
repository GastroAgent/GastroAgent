...
# ===== 配置参数 =====
data_name = '十二指肠'
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/十二指肠_doctor_exam/LlavaQwen2-GRPO-Tricks-Total-CoT-6000/new_eval_tsy_llm_with_trigger.json'
output_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/十二指肠_doctor_exam/LlavaQwen2-GRPO-Tricks-Total-CoT-6000/new_eval_tsy_llm_extracted.json'
