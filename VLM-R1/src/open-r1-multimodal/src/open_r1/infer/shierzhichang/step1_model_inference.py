...
data_name = '十二指肠'
batch_size = 1
model_name = 'Llava-Qwen2-7B-tune-med-SFT-RL-New'

# 输入输出路径
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/十二指肠_doctor_exam/new_eval_tsy_llm.json'
output_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/十二指肠_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New1-0.5/new_eval_tsy_llm_with_trigger.json'
...
#THRES_ENTROPY = 0.48    # 归一化熵阈值
THRES_ENTROPY = 0.5    # 归一化熵阈值
