...
# ===== 配置参数 =====
data_name = '十二指肠'
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/十二指肠_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New1-0.5/new_eval_tsy_llm_final.json'
output_report_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/十二指肠_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New1-0.5/new_eval_tsy_llm_trigger_report.json'
