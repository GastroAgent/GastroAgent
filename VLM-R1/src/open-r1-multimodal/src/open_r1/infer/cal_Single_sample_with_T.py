...
import sys
sys.path.append('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match')
sys.path.append('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/utils')
...
try:
    ...
    # _lpips_model = lpips.LPIPS(net='alex').to(self.device if torch.cuda.is_available() else 'cpu').eval()
...
class TripletNetworkNorm(nn.Module):
    def __init__(self, pretrained=True, freeze_base=False, model='resnet34'):
        super(TripletNetworkNorm, self).__init__()
        if model == 'attention':
...
class ImageGenerator:
        ...
        if not self.only_vae:
            ...
            if  self.args.wass_model_path:
                if 'attention.pt' in self.args.wass_model_path:
                    model = TripletNetworkNorm(pretrained=True, freeze_base=False, model='attention')
                else:
                    model = TripletNetworkNorm(pretrained=True, freeze_base=False, model='resnet34')
                ...
                model = TripletNetworkNorm(pretrained=True, freeze_base=False, model=self.args.wass_model_type)
            ...
            if self.args.sim_model_type == 'gme':
                ...
                import sys
                sys.path.append("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/discriminator")
                sys.path.append('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match')
                sys.path.append('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/utils')
    ...
    def get_conds_from_items(self, x0, x1, x0_path, x1_path, label_id, caption, transform, transform_grey, **kwargs):
        conds = {}
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/data/exam_wass_dataset_test_k3.json',
                        help='数据路径')
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/flow_match/outputs/disease_self_exam_json_endovit_image_hint_wassmodelDXL_nfree/otcfm/otcfm_weights_step_50000.pt',
                        # default='/mnt/inaisfs/data/home/tansy_criait/flow_match/outputs/disease_self_exam_json_endovit_image_hint_resnetmodel_nfree/otcfm/otcfm_weights_step_50000.pt',
                        # default='/mnt/inaisfs/data/home/tansy_criait/flow_match/outputs/disease_self_exam_json_endovit_image_hint_all/otcfm/otcfm_weights_step_30000.pt',
                        help='Path to the checkpoint file')
    parser.add_argument('--output_dir', type=str,
                        # default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/result_k5/disease_self_exam_json_endovit_image_hint_wassmodelDXL_nfree_NoCacheT_direct_bias_chec',
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/result_k1/disease_self_exam_json_endovit_image_hint_all',
                        help='Directory to save generated images')
    parser.add_argument('--wass_model_path', type=str, 
                        # default="/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/generatedAUGnoMask_vae_model_weight/all_attention.pt",
                        default="/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/generatedAUGnoMask_vae_model_weight/attention.pt",
    ...
    parser.add_argument('--sim_model_type', type=str, 
                        choices=['gme', 'dinov3', 'convnext'], # convnext 是我们的。
                        default="dinov3",
                        help='指定相似模型类型')
    parser.add_argument('--sim_model_path', type=str, 
                        default="/mnt/inaisfs/data/home/tansy_criait/weights/dinov3-vit7b16",
                        # /mnt/inaisfs/data/home/tansy_criait/wass_flow_match/discriminator/latent_model_weight/convnext2.pt
                        help='指定相似模型类型')
    ...
    parser.add_argument('--temp', type=str, default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match/cal_wass/temp4',
                        help='')
