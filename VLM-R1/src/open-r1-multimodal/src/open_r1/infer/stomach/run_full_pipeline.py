...
STEPS = [
    {
        ...
        'script': '/mnt/inaisfs/data/home/tansy_criait/VLM-R1/src/open-r1-multimodal/src/open_r1/infer/stomach/step1_model_inference.py',
        'description': '对输入数据进行模型推理，计算概率分布和trigger指标',
    },
    {
        'name': '步骤2: LLM提取答案',
        'script': '/mnt/inaisfs/data/home/tansy_criait/VLM-R1/src/open-r1-multimodal/src/open_r1/infer/stomach/step2_extract_answers_with_llm_latest.py',
        'description': '使用LLM从生成文本中提取标准化答案',
    },
    {
        'name': '步骤3: 重新评估correct',
        'script': '/mnt/inaisfs/data/home/tansy_criait/VLM-R1/src/open-r1-multimodal/src/open_r1/infer/stomach/step3_reevaluate_correct.py',
        'description': '根据提取的答案重新计算correct字段',
    },
    {
        'name': '步骤4: 重新分析Trigger性能',
        'script': '/mnt/inaisfs/data/home/tansy_criait/VLM-R1/src/open-r1-multimodal/src/open_r1/infer/stomach/step4_reanalyze_trigger_performance.py',
