...
# 输入输出路径
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/胃_doctor_exam/new_eval_tsy_llm.json'
output_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/胃_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New-latest-consis/new_eval_tsy_llm_with_trigger.json'
