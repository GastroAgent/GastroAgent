...
# ===== 配置参数 =====
data_name = '胃'
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/胃_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New/new_eval_tsy_llm_with_trigger.json'
output_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/胃_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New/new_eval_tsy_llm_extracted.json'
