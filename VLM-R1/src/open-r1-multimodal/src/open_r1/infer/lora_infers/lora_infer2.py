...
model_id = '/home/dalhxwlyjsuo/criait_tansy/weight/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-next-Stage3_Epoch5-Redo'
...
data_name = 'Kvasir-en'
batch_size = 1 
model_name = 'LlavaQwen2-MyGRPO-Tricks-Stage3-Epoch5-Redo' # 2: is_message=True
is_message = True
...
# sbatch -p vip_gpu_01 --gpus=1 /home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/src/open_r1/infer/lora_infers/lora_infer2.sh
...
lora_model_path = '/home/dalhxwlyjsuo/criait_tansy/GRPO_checkpoints/LlavaQwen2-MyGRPO-Tricks-Stage3-Epoch5-Redo/checkpoint-4000'
