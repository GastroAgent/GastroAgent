...
# ===== 配置参数 =====
data_name = '食管'
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New-latest-consis/new_eval_tsy_llm_with_trigger.json'
output_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New-latest-consis/new_eval_tsy_llm_extracted.json'
...
def extract_answer_by_rule(text: str) -> Optional[str]:
    ...
    基于规则的答案提取（后备方案）
    """
    # 优先提取 <answer> 标签内的内容（支持 option_C / _C / C）
...
4. If multiple letters appear, prioritize the one in the answer section
5. If no clear answer is found, return "UNKNOWN"
6. Return ONLY the letter, nothing else
