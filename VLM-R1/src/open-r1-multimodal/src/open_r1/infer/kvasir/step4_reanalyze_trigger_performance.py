...
# ===== 配置参数 =====
data_name = 'kvasir'
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/kvasir_doctor_exam/cot-419-0.4/new_eval_tsy_llm_final.json'
output_report_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/kvasir_doctor_exam/cot-419-0.4/new_eval_tsy_llm_trigger_report.json'
