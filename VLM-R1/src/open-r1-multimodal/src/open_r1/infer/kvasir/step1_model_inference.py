...
# 输入输出路径
input_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/kvasir_doctor_exam/new_eval_tsy_llm_all.json'
output_data_path = f'/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/kvasir_doctor_exam/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-75-final105/new_eval_tsy_llm_with_trigger.json'
