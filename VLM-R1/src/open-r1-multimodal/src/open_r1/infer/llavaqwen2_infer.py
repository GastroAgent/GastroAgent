...
model_id = '/home/dalhxwlyjsuo/criait_tansy/weights/Llava-Qwen2-7B-tune-med-v0-mmtag-mul-Latest-75'

data_name = 'Kvasir-en'
batch_size = 1
model_name = 'Llava-Qwen2-7B-tune-med-Error' # 2: is_message=True
is_message = True
...
question_ids = []
files = [
    '/home/dalhxwlyjsuo/criait_tansy/Node_Code/126/work/Diffusion/flow-based-models/test_data/0.719-diease-soft_no_303false_息肉_100false.json',
    '/home/dalhxwlyjsuo/criait_tansy/Node_Code/126/work/Diffusion/flow-based-models/test_data/0.719-diease-soft_no_303false_染色息肉_31false.json',
    '/home/dalhxwlyjsuo/criait_tansy/Node_Code/126/work/Diffusion/flow-based-models/test_data/0.719-diease-soft_no_303false_染色边缘_23false.json',
    '/home/dalhxwlyjsuo/criait_tansy/Node_Code/126/work/Diffusion/flow-based-models/test_data/0.719-diease-soft_no_303false_溃疡结肠炎_106false.json',
    '/home/dalhxwlyjsuo/criait_tansy/Node_Code/126/work/Diffusion/flow-based-models/test_data/0.719-diease-soft_no_303false_食管炎_43false.json'
]
for file in files:
...
dataset = new_dataset
print("Error(New) Dataset Size: ", len(dataset))
# 处理图像
...
for i in range(0, len(dataset), batch_size):
    ...
    # if 'easy' in data_name:
    #     prompts_text = [example.replace('<|Image_start><image><|Image_end|>', '<image>') for example in prompts_text]
    # else:
    #     prompts_text = [example.replace('<|Image_start><image><|Image_end|>', '<image>') for example in prompts_text]
    #     prompts_text = [example.replace('<image>', '<|Image_start><image><|Image_end|>') for example in prompts_text]
