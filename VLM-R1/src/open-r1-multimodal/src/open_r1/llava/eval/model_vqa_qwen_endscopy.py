...
def eval_model(args, question_file, answers_base_path):
    ...
    with open(os.path.join(answers_base_path, os.path.dirname(question_file).replace('/', '_') + '.json'), 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str, default="/home/work/ds-vl-on-policy_test/ACRIMA.json")
    parser.add_argument("--answers-file", type=str, default="/home/work/ds-vl-on-policy_test/ACRIMA.json")
    ...
    parser.add_argument('--answers_base_path', type=str, default="qwen_med_output_sft_zh_vitpretrain")
