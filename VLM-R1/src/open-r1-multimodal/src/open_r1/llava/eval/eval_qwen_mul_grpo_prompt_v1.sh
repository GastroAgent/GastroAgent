...
python /home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/src/open_r1/llava/eval/model_vqa_qwen_mul.py \
    ...
    --question-file /home/dalhxwlyjsuo/criait_tansy/project/Llava_Qwen2/data/instruct_prompt_step_gen_v1_folder.json \
    --answers-file /home/dalhxwlyjsuo/criait_tansy/project/Llava_Qwen2/data/answer/mulimg/answer-grpo-mul-prompt-v1.json \
    #--conv-mode vicuna_v1