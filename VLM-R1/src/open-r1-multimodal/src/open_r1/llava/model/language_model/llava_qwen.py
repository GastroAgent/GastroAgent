...
from transformers import AutoConfig, AutoModelForCausalLM, Qwen2Config, Qwen2Model, Qwen2ForCausalLM, AutoProcessor, AutoImageProcessor, AutoModel
...
# AutoModel.register(LlavaConfig, LlavaQwen2ForCausalLM)
