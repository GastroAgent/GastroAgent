...
import torch
import sys
sys.path.append('/home/work/VLM-R1/src/open-r1-multimodal/src/open_r1/llava')
sys.path.append('/home/dalhxwlyjsuo/criait_tansy/jmf/VLM-R1/src/open-r1-multimodal/src/open_r1/llava')
import transformers
import tokenizers

from constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from torch.utils.data import Dataset
from llava_trainer_med import LLaVATrainer
    ...
    for source in sources:
        for sentence in source:
            if DEFAULT_IMAGE_TOKEN in str(sentence['value']):
                cur_num_image = sentence['value'].count(DEFAULT_IMAGE_TOKEN)
                ...
                if "mmtag" in conversation_lib.default_conversation.version:
                    sentence['value'] = sentence['value'].replace(DEFAULT_IMAGE_TOKEN, c)
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            # model = LlavaMptForCausalLM(MptConfig(num_hidden_layers=1))
        else:
            print('======1111111')
            from transformers import  Qwen2Config
            from model.language_model.llava_qwen import LlavaQwen2ForCausalLM
            # config = Qwen2Config.from_pretrained('/mnt/d/pythonProject2024spring/work/code/model_match/our_model')
            ...
            print('=======222222')
            from transformers import Qwen2_5_VLConfig, Qwen2Config, Qwen2_5_VLForConditionalGeneration
            from transformers import AutoModel, AutoTokenizer, AutoProcessor
            vl_config = Qwen2_5_VLConfig.from_pretrained('/mnt/d/pythonProject2024spring/work/code/model_match/Qwen2.5-VL-7B-Instruct')
    ...
    if training_args.lora_enable:
        ...
        lora_config = LoraConfig(
            ...
            target_modules=find_all_linear_names(model) if training_args.target_modules is None else [x.strip() for x in training_args.target_modules.split(',')],
