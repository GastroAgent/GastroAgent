...
# os.environ['CUDA_VISIBLE_DEVICES'] = '5,4,2'
import gc
...
sys.path.append('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃')
sys.path.append('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/utils')
...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", type=str,
                        default="/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/outputs/image_hint_胃_wm",
    ...
    parser.add_argument("--log_dir", type=str,
                        default="/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/logs_attn",
...
def train(args):
    ...
    use_image_mask = True
    checkpoints = '/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/outputs/image_hint_胃/otcfm/otcfm_weights_step_50000.pt'
    ...
    dataloaders = []
    json_paths = glob.glob("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data/data_pairs_tiny2/*.json")
    ...
    config = json.load(open('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/flow_matcher_otcfm/unet/config.json', 'r'))
    ...
    try:
        ...
        print(e)
        pass
    vae = AutoencoderKL.from_pretrained('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/flow_matcher_otcfm/vae').eval()
    ...
    if use_image_feature:
        ...
        vision_model.load_state_dict(torch.load("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/flow_matcher_otcfm/EndoViT/pytorch_model.bin", weights_only=False))
    else:
        vision_model = None
    ...
    if use_text_feature:
        config_json = json.load(open('/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/flow_matcher_otcfm/text_encoder/config.json', 'r'))
        config = ChineseCLIPTextConfig(**config_json)
        text_model = ChineseCLIPTextModel(config, False).eval()
        text_tokenizer = AutoTokenizer.from_pretrained(
            '/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/flow_matcher_otcfm/text_encoder', use_fast=True)
        try:
    ...
    #     '/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/outputs/disease_A2B/otcfm_weights_step_2000_A2D.pt')
    ...
    state_dict = torch.load("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/best_flow_weights/attention_tiny.pt")
    ...
    with trange(start_step, args.total_steps, initial=start_step, total=args.total_steps,
        ...
        for step in step_pbar:
            ...
            # if 'mask_hint' in batch and random.random() < 0.85:
            ...
            wasserstein_loss_beta = 1.024
            wasserstein_loss_beta_neighbor = 0.1024
            if Wasserstein_loss:
