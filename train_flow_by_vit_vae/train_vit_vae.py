...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", type=str,
                        default="/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/outputs/flow-match_vit-vae",
...
def train(args):
    ...
    dataloaders = []
    json_paths = glob.glob("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/data_tsy1/train_json/All_data_pairs/*.json")
