...
class ImageGenerator:
    ...
    def _load_model(self, checkpoint: str, use_ema=False):
        ...
        if not self.use_gt_vt:
            ...
            try:
                state_dict = load_file("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/flow_matcher_otcfm/text_encoder/model.safetensors")
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data_tsy/胃_doctor/final_doctor_exam_flat.json',
                        help='数据路径') 
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/checkpoints_tsy/image_hint_stomach_base_support/otcfm/otcfm_weights_step_40000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/result_tsy/doctor/image_hint_胃_step1_40000_doctor_exam5',
    ...
    parser.add_argument('--bias', type=bool, default=False,
                        help='')  
    parser.add_argument('--temp', type=str, default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/temp/temp2',
                        help='')
    ...
    parser.add_argument('--wass_model_path', type=str, 
                        default="/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/best_flow_weights_tsy/doctor_exam/batch8/loss/23.22/attention.pt",
                        help='优先级 高于 权重')
