...
class ImageGenerator:
    ...
    def _load_model(self, checkpoint: str, use_ema=False):
        ...
        if not self.only_vae:
            ...
            text_model.load_state_dict(load_file("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/text_model/model.safetensors"), strict=False)
            text_tokenizer = AutoTokenizer.from_pretrained(
                '/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/text_model', use_fast=True)
...
def generate_parse_args():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/checkpoints_tsy/image_hint_stomach_step4/otcfm/otcfm_weights_step_75000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/result_tsy/image_hint_胃_flow_matcher_v1',
