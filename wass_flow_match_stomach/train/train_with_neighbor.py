...
sys.path.append('/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/wass_flow_train_kvasir_Anatomy')
...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", type=str,
                        default="/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/checkpoints_tsy/image_hint_stomach_step4_doctor_exam",
    ...
    parser.add_argument("--total_steps", type=int, default=85000,
    ...
    parser.add_argument("--log_dir", type=str,
                        default="/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/logs_wm_neighbor",
...
def train(args):
    ...
    dataloaders = []
    json_paths = glob.glob("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/data_tsy/train_flow/data_pairs_flow_base_su/*.json") # 3, 2, 1
    ...
    config = json.load(open('/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/unet/config.json', 'r'))
    ...
    try:
        ...
        print(e)
        pass
    vae = AutoencoderKL.from_pretrained('/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/vae').eval()
    ...
    if use_image_feature:
        ...
        vision_model.load_state_dict(torch.load("/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/EndoViT/pytorch_model.bin", weights_only=False))
    else:
        vision_model = None
    ...
    if use_text_feature:
        config_json = json.load(open('/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/flow_matcher_otcfm/text_encoder/config.json', 'r'))
    ...
    #     '/mnt/inaisfs/data/home/tansy_criait/whole_wass_flow_match/outputs/disease_A2B/otcfm_weights_step_2000_A2D.pt')
    ...
    state_dict = torch.load("/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_胃/best_flow_weights_tsy/doctor_exam/batch8/loss/23.22/attention.pt")
