...
from my_models.model_wass import AttentionDownEncoderXL
...
def sinkhorn_custom_loss(bx, bx1, epsilon=0.1, n_iter=25, reduction='sum', **kwargs):
    """
    ...
    def _load_model(self, checkpoint: str, use_ema=False):
        ...
        if not self.use_gt_vt:
            ...
            if  self.args.wass_model_path:
                from train_vae_with_flow_matcher import TripletNetwork
