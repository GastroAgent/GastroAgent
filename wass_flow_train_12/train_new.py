...
if __name__ == '__main__':
    ...
    model = TripletNetwork(pretrained=False, freeze_base=False, model='attention', dy=True, cat=True).to(device) # vit-vae
    test_json = [
        "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/data_tsy_12/support_54",
    ]
    # resumed_path = '/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_tsy' # 0.1556
    # resumed_path = "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_tsy2" # 0.25
    # resumed_path = "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_raw" # 0.2074
    resumed_path = '/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_cat' # 0.1926
    ...
    def train_triplet(epochs=20, dataloaders=None):
        ...
        for step in tqdm(range(total_step)):
            ...
            ### 三元组损失
            loss = loss + 1.5 * criterion_triplet(anchor_emb, positive_emb, negative_emb, 1, 1.0)
            wass_loss = (beta * cal_wasserstein_loss(anchor_emb, positive_emb).mean() + 1 - torch.clamp(1.25 * beta * cal_wasserstein_loss(anchor_emb, negative_emb).mean(), max=1))
            loss = loss + wass_loss 
            
            ### 对比损失型
            # loss = loss + 0.1 * wasserstein_clip_triplet_loss(anchor_emb, positive_emb, negative_emb)
            # loss = loss + 0.1 * wasserstein_clip_triplet_loss(positive_emb, anchor_emb, negative_emb)
            ...
            # 最小匹配MSE 辅助
            # mse_loss = min_match_wass_loss(anchor_emb, positive_emb)
            # neg_mse_loss = 1 - torch.clamp_max(min_match_wass_loss(negative_emb, positive_emb), 1)
            # loss = loss + (0.1 * mse_loss + 0.25 * neg_mse_loss).mean()
            ...
            if (step + 1) % save_step == 0:
                ...
                if best_acc < accuracy:
                    torch.save(model.state_dict(), f"{resumed_path}/model.pt")
                    torch.save(classifer.state_dict(), f"{resumed_path}/classifer.pt")
                    best_acc = accuracy
                else:
                    pass
    ...
    ### 加载 checkpoints
    try:
        state_dict = torch.load(f"{resumed_path}/model.pt", weights_only=True)
        model.load_state_dict(state_dict, strict=True)
        state_dict = torch.load(f"{resumed_path}/classifer.pt", weights_only=True)
    ...
    ####################################
    model = TripletNetwork(pretrained=False, freeze_base=False, model='attention', dy=False, cat=False).to(device)
    test_json = [
    ...
    checkpoinsts = [
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_cat", # 0.3185
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new" # 0.3111
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_nody" # 0.4741
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_nody_cat" # 0.400
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_remapper", # 0.2148
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_tsy_remapper", # 0.2148
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_remapper", # 0.2074
        # "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_tsy_remapper" # 0.1926
        "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_tiny.pt", # 0.47
        "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/new_attention_tiny.pt", # 0.57
        "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_tiny2.pt" # 0.51
    ]
    # 9s9WGzvh
    for path in checkpoinsts:
        ...
        print(path)
        try:
            # state_dict = torch.load(f"{path}/model.pt", weights_only=True)
    ...
    # test_json = [
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/data_tsy_12/eval_json/eval_tsy.json",
    # ]
    # dataset = []
    # for i in test_json:
    #     dataset += json.load(open(i, "r"))
    # # evaluate_triplet(model, dataset, device, generator, 0)
    # checkpoinsts = [
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_raw",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_raw_remapper",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_remapper",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_new_tsy_remapper",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_raw",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_raw_remapper",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_remapper",
    #     "/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/best_flow_weights_12/attention_tsy_remapper",
    # ]
    # # 9s9WGzvh
    # for path in checkpoinsts:
    #     print(test_json[0])
