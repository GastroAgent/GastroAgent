...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/outputs/flow-match_vae/otcfm/otcfm_weights_step_80000.pt',
                        help='Path to the checkpoint file') 
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/inaisfs/data/home/tansy_criait/wass_flow_match_tsy/result/attention_dy_tsy_80000_sim2_mm88',
