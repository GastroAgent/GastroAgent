...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str,
                        ...
                        # default='./GasAgent-main/dataset/eval_data/exam_dataset_419_k5.json',
                        help='数据路径') 
    ...
    parser.add_argument('--sim_model_path', type=str, 
                        # default = "./new_wass_flow_match/discriminator/latent_model_weight/convnext2.pt",
                        default = "./discriminator/latent_model_weight/convnext2.pt",
                        # default="./weights/dinov3-vit7b16",
                        help='指定相似模型类型')
