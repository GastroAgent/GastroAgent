...
def main():
    ...
    parser.add_argument(
        '--mllm-path',
        default='/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New4/new_eval_tsy_llm_final.json',
        help='MLLM结果文件路径（相对于agent_latest目录）'
    )
    parser.add_argument(
        '--flow-path',
        default='/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New4/kshot/eval_by_x0_clean_fixed.json',
        help='Flow结果文件路径（相对于agent_latest目录）'
    )
    parser.add_argument(
        '--output-dir',
        default='/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New4/fusion',
