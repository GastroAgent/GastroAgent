...
# ===== 自己改这里 =====
JSON1 = Path("/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New1/kshot/new_eval_tsy_llm_final_true.json")   # 含 question_id / image_paths 的文件
JSON2 = Path("/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New1/kshot/eval_by_x0_clean_fixed1.json")  # 含 x0 的文件
OUT   = Path("/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New1/kshot/食管mllm_kshot_latest_acc.json") # 输出匹配后的新文件
# =====================
