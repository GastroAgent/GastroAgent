...
dataset = json.load(open("/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/胃_doctor_exam/final_doctor_exam.json"))
new_dataset = []
options = {
    0: "option_A",
    1: "option_B",
...
with open("/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/胃_doctor_exam/new_eval_tsy_llm.json", "w") as f:
