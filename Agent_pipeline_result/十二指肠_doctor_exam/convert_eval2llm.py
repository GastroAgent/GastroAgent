...
dataset = json.load(open("/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/halt/shierzhichang/135/eval_tsy.json"))
new_dataset = []
options = {
    0: "option_A",
    1: "option_B",
...
with open("/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/halt/shierzhichang/135/new_eval_tsy_llm.json", "w") as f:
