...
# ===== 1. 路径自己改这里 =====
JSON_PATH = Path(
    "/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New4/new_eval_tsy_llm_final.json"
)

OUT_JSON = Path(
   "/mnt/inaisfs/data/home/tansy_criait/VLM-R1/data/Eval/食管_doctor_exam/Llava-Qwen2-7B-tune-med-SFT-RL-New4/kshot/new_eval_tsy_llm_final_true.json"
)
# ======================================
